...
Variant: medium-framework-local-brief
...
- Include complete local SEO basics: descriptive title, exactly one H1 with roofing + service area, LocalBusiness/RoofingContractor JSON-LD with telephone and areaServed/address placeholder, and a Google Maps/directions link placeholder.
  ...
  "sections": [
    ...
    },
    {
      ...
      "required": [
        ...
        "service area",
        "hours",
        "directions/map link placeholder",
        "complete footer"
      ]
    }
  ]
