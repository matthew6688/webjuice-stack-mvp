---
business_id: "domain_hookysroofing.sydney"
business_name: "Hookys Roofing | Professional Roofing Service Sydney"
niche: "roofing"
city: "Sydney"
rating: 4.8
review_count: 0
website: "https://hookysroofing.sydney/?utm_source=google_business_profile&utm_medium=gbp_view_website"
audit_score: 27
...
generated_at: "2026-05-14T22:05:20.466Z"
assets:
...
# Hookys Roofing | Professional Roofing Service Sydney · 现状审计与重构提议

> **27/100** · strong_redesign · 行业：roofing · 地区：Sydney · Google 评价：4.8★ （0 条）
...
**触发依据：**
- C · strong_redesign · audit 27 · 0 评论 4.8★ (未达 B 标准)
...
**审计结论：** audit_score=27 → strong_redesign · weakest: ux_conversion 0, content 10 · fired: no_visible_cta_or_phone · 2 critical issues

**已触发的 hard triggers：** `no_visible_cta_or_phone`

- 电话：0408026601
- 地址：16/28-34 Roseberry St, Balgowlah NSW 2093
- 网站：[https://hookysroofing.sydney/?utm_source=google_business_profile&utm_medium=gbp_view_website](https://hookysroofing.sydney/?utm_source=google_business_profile&utm_medium=gbp_view_website)
...
你网站的浏览器标签 title 没把业务名字 + 服务关键词写清楚（比如该写「Hookys Roofing | Professional Roofing Service Sydney - roofing Sydney」，但目前是泛泛一句）。
...
| 维度 | 分数 |
|---|---|
| 性能 (Performance) | **44/100** |
| 可访问性 (Accessibility) | 81/100 |
| 最佳实践 (Best Practices) | 96/100 |
| SEO | 92/100 |

**Lab 关键指标：** LCP `9.9s` · FCP `4.8s` · CLS `0.031` · TBT `496ms`

**Google 建议的优化项（按节省时间排序，前 2）：**

- **Reduce unused JavaScript** — 节省 2050ms · 节省 1147KB
- **Reduce unused CSS** — 节省 600ms · 节省 115KB
...
- **Sitemap 状态：** 已检测到 → `https://hookysroofing.sydney/sitemap_index.xml`
- **页面总数：** 153
...
**Sitemap lastmod 跨度：** 最旧 2018-11-16 → 最新 2026-05-12
...
- **服务专项页（如 /metal-roofing/）：** 70 个
- **区域页（如 /service-areas/brisbane/）：** 2 个
- **服务×区域组合页（如 /metal-roofing-brisbane/）：** 54 个

**长尾覆盖：** 强 — 已有 5+ 服务×区域页，长尾流量基础在

**现有服务页样本：** `/replace-guttering-and-downpipes/` · `/cost-to-replace-tiled-roof-with-colorbond/` · `/best-roof-colour-to-reflect-heat-in-australia/` · `/can-roof-restoration-in-ryde-help-with-home-insulation-heres-what-to-know/` · `/how-often-should-you-inspect-your-roof-in-lane-coves-climate/`

**现有服务×区域页样本：** `/emergency-roof-repairs-sydney/` · `/metal-roof-waterproofing-for-long-term-protection/` · `/signs-your-roof-space-isnt-ventilated-properly/` · `/tile-to-metal-roof-conversion-sydney/` · `/prevent-fix-gutter-blockages-sydney-storm-season/`
...
- **域名"在线已"约：** 11 年（创建于 2014-10-30）— 老域名 = 多年 SEO 资产，redesign 时 redirect map 必须做对
...
- [PASS] `llms_txt_present` — llms.txt found (105601 bytes)
