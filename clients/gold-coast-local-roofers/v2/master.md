---
business_id: "domain_goldcoastlocalroofers.com.au"
business_name: "Gold Coast Local Roofers"
niche: "roofing"
city: "Gold Coast"
rating: 5
review_count: 0
website: "https://goldcoastlocalroofers.com.au/"
audit_score: 27
...
generated_at: "2026-05-14T21:27:59.984Z"
assets:
...
# Gold Coast Local Roofers · 现状审计与重构提议

> **27/100** · strong_redesign · 行业：roofing · 地区：Gold Coast · Google 评价：5★ （0 条）
...
- 电话：(07)52305802
- 地址：193 Sunshine Blvd, Mermaid Waters QLD 4218
- 网站：[https://goldcoastlocalroofers.com.au/](https://goldcoastlocalroofers.com.au/)
...
你网站的浏览器标签 title 没把业务名字 + 服务关键词写清楚（比如该写「Gold Coast Local Roofers - roofing Gold Coast」，但目前是泛泛一句）。
...
**Lab 关键指标：** LCP `15.6s` · FCP `2.9s` · CLS `0.010` · TBT `79ms`

**Google 建议的优化项（按节省时间排序，前 2）：**

- **Reduce unused JavaScript** — 节省 1350ms · 节省 259KB
- **Reduce unused CSS** — 节省 300ms · 节省 45KB

### 桌面端（desktop）

**Lighthouse 分数：** Performance 64 · A11y 89 · Best Practices 100 · SEO 85
...
- **Sitemap 状态：** 已检测到 → `https://goldcoastlocalroofers.com.au/sitemap_index.xml`
- **页面总数：** 96
...
**Sitemap lastmod 跨度：** 最旧 2023-11-01 → 最新 2026-03-18
...
- **服务专项页（如 /metal-roofing/）：** 64 个
- **区域页（如 /service-areas/brisbane/）：** 0 个
- **服务×区域组合页（如 /metal-roofing-brisbane/）：** 20 个

**长尾覆盖：** 强 — 已有 5+ 服务×区域页，长尾流量基础在

**现有服务页样本：** `/skylight-installation/` · `/parapet-roof-benefits/` · `/skylight-repairs/` · `/durable-roof-types/` · `/unblocking-gutters-and-downpipes/`

**现有服务×区域页样本：** `/roof-leak-contacts/` · `/roof-sarking/` · `/roof-bedding-and-pointing/` · `/solar-roof-ventilation/` · `/roof-replacement-signs/`

### 运营活跃度

- **整体活跃度：** 近期（90 天内有更新） （最近一次更新 58 天前）
- **Blog 板块：** 有，共 1 篇文章 
- **社交媒体链接：** 网站上没有 social 链接 — GBP 流量进来后没有第二触点

## 域名历史与邮件信誉

- **域名"在线已"约：** 1 年（Wayback 首次快照 2024-07-25 起算（.au 域名无公开创建日期））— 相对年轻的域名
- **Wayback Machine 快照：** 6 条（2024-07-25 → 2025-08-06）
