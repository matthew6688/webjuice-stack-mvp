---
business_id: "domain_n1roofrestorations.com.au"
business_name: "N.1 Roof Restorations"
niche: "roofing"
city: "Gold Coast"
rating: 4.9
review_count: 0
website: "https://n1roofrestorations.com.au/"
audit_score: 27
...
generated_at: "2026-05-14T21:28:26.500Z"
assets:
...
# N.1 Roof Restorations · 现状审计与重构提议

> **27/100** · strong_redesign · 行业：roofing · 地区：Gold Coast · Google 评价：4.9★ （0 条）
...
**触发依据：**
- C · strong_redesign · audit 27 · 0 评论 4.9★ (未达 B 标准)
...
- 电话：0429047629
- 地址：Central St, Arundel QLD 4214
- 网站：[https://n1roofrestorations.com.au/](https://n1roofrestorations.com.au/)
...
你网站的浏览器标签 title 没把业务名字 + 服务关键词写清楚（比如该写「N.1 Roof Restorations - roofing Gold Coast」，但目前是泛泛一句）。
...
**Lab 关键指标：** LCP `15.0s` · FCP `7.8s` · CLS `0.000` · TBT `5ms`

**Google 建议的优化项（按节省时间排序，前 2）：**

- **Reduce unused CSS** — 节省 150ms · 节省 57KB
- **Reduce unused JavaScript** — 节省 20KB

### 桌面端（desktop）

**Lighthouse 分数：** Performance 62 · A11y 90 · Best Practices 73 · SEO 92
...
- **Sitemap 状态：** 已检测到 → `https://n1roofrestorations.com.au/wp-sitemap.xml`
- **页面总数：** 20
...
**Sitemap lastmod 跨度：** 最旧 2025-08-13 → 最新 2026-03-13

**Redirect 计划承诺：** redesign 上线时我们会附一份 20 条 1:1 redirect 表（旧 URL → 新 URL），保证 Google 已经索引的页面权重无损迁移。已经在 Google 第一二页的关键词不会丢。

### SEO 长尾结构（服务 × 区域 = 本地搜索流量金矿）

- **服务专项页（如 /metal-roofing/）：** 0 个
- **区域页（如 /service-areas/brisbane/）：** 5 个
...
- **整体活跃度：** 近期（90 天内有更新） （最近一次更新 63 天前）
