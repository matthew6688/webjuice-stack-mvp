...
assets:
  ...
  evidence_count: 0
  video_url: "https://vip-roofing-brisbane-dev.pages.dev/video/mobile-throttled.webm"
  desktop_screenshot: "https://vip-roofing-brisbane-dev.pages.dev/screenshots/desktop.png"
  mobile_screenshot: "https://vip-roofing-brisbane-dev.pages.dev/screenshots/mobile.png"
---
...
![桌面 1440×900](https://vip-roofing-brisbane-dev.pages.dev/screenshots/desktop.png)

![移动 375×667](https://vip-roofing-brisbane-dev.pages.dev/screenshots/mobile.png)

**慢速 4G 加载实景视频**（1.6 Mbps · 150ms 延迟 · 4× CPU 节流，模拟真实手机访客的体验）：

[播放视频](https://vip-roofing-brisbane-dev.pages.dev/video/mobile-throttled.webm)
