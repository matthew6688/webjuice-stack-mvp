...
| iter 7 Block G end-to-end pipeline CLI | ✅ | (this commit) | `npm run leads:run-pipeline -- --entity-key X [--with-reviews] [--refetch]`：detailed → vision → reviews → report 一条命令跑通；fixture 智能复用 |
