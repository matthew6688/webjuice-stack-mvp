...
| Sprint 3 Master MD 合成器 + huashu-md-html 渲染 | ✅ | (this commit) | 每个 lead 一份 `master.md`（含 frontmatter + 8 章节中文叙事 + 所有 Cloudinary URL）；`npm run leads:build-master-md -- --html --theme report` 一条命令出 polished HTML；10/10 lead 跑通 |
