...
| Sprint 4 本地 Docker reviews + 技术栈 / pixel / CMS 检测 | ✅ | (this commit) | gosom Docker 拉 221 条全量评论（vs Places 5）+ 评分分布；rawHtml 检测 WordPress / GA4 / GTM / Google Ads / Meta Pixel / Hotjar / UA(过期) 等；master.md 加「技术栈与营销基建」+ 评分分布表；Diamond Roof Tiling 自动触发「UA 已 2 年没数据」销售点 |
