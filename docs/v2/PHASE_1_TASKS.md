...
| Sprint 1 上游过滤质量 (niche_mismatch + 第三方平台 + evidence 清理) | ✅ | (this commit) | Hurricane Digital (SEO 代理商) 现在 niche_mismatch → skip；FIX MY ROOF 的 billdu.me → third_party_landing_page → starter_candidate；evidence dir 写入前清空，stale PNG 不再累积 |
