...
t('TERMINAL_FAIL_PATHS has 12 entries (cycle-27 Bug D added stage7_brief_failed)', () => {
  assert.equal(TERMINAL_FAIL_PATHS.length, 12, `expected 12 terminal paths, got ${TERMINAL_FAIL_PATHS.length}`);
});
